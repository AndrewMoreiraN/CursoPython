...
from PyQt5.QtWidgets import QGridLayout, QLineEdit, QSizePolicy
...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Calculadora do Andrew')
        ...
        self.add_btn(QPushButton(''), 3, 4, 1, 1, lambda: self.display.setText('Também sou.'))

        self.add_btn(QPushButton('.'), 4, 0, 1, 1)
        self.add_btn(QPushButton('0'), 4, 1, 1, 1)
        self.add_btn(QPushButton('M'), 4, 2, 1, 1, lambda: self.display.setText('Mãe Errada.'))
